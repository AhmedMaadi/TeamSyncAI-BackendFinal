...
import { createDefaultTask, createTask, deleteTask, getTaskByUserId, getTasksByModuleID, updateTask,markTaskAsCompleted, getTasksByProjectID } from '../controllers/taskController.js';

const router = Router();

router.post('/', createTask);
router.get('/modul/:module_id', getTasksByModuleID);
router.post('/byProjectID', getTasksByProjectID);router.put('/:id', updateTask);
